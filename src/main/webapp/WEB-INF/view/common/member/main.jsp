        ...
        <section class="menu_con">
            ...
            <div class="menu_items">
                <div class="menu_item_box">
                    <a class="item_title" href="MemberController?view=u09_01.html">My QRコード</a><br>
                    <span>
                        自分のQRコードが確認できます。<br>
                ...
                <div class="menu_item_box">
                    <a class="item_title" href='MemberController?view=u06_01.html'>マイページ</a><br>
                    <span>
                        個人情報の確認・変更・退会<br>
                        問診票の変更ができます。
                    </span>
            ...
            <div class="menu_items">
                <div class="menu_item_box">
                    <a class="item_title" href="MemberController?view=u07_01.html">子供情報</a><br>
                    <span>子供情報の登録・変更・削除ができます。</span>
                </div>
                <div class="menu_item_box">
                    <a class="item_title" href="MemberController?view=u08_01.html">薬歴</a><br>
